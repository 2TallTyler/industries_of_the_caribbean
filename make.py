...
unordered_stuff = ["coffee_plantation", "citrus_grove", "import_export", "sugarcane_plantation", "sugar_mill", "oil_refinery", "nickel_mine", "nickel_smelter", "rum_distillery", "tobacco_plantation", "cigar_factory"]
